namespace Persistence
{
    ...
    //        SqlDataReader dataReader = Conexion.ExcuteReader("dbo.retiros_getByFecha", ParametersList);
    ...
    //        SqlDataReader dataReader = Conexion.ExcuteReader("dbo.retiros_getRetiro", ParametersList);
    //        while (dataReader.Read())
    //        {
    ...
    //        return Conexion.ExecuteNonQuery("dbo.retiros_efectuado", ParametersList);
            

    //    }

    //    public static bool insert(retiroData r, bool connLocal = true)
    //    {
    //        List<SqlParameter> ParametersList = new List<SqlParameter>();
    ...
    //        return Conexion.ExecuteNonQuery("dbo.retiros_insert", ParametersList, true, connLocal);
    //    }
    ...
    //        SqlDataReader dataReader = Conexion.ExcuteReader("dbo.retiros_getLast", ParametersList, connLocal);
    //        while (dataReader.Read())
    //        {
    ...
    //    public static List<retiroData> getOlderThan(DateTime fecha, Guid idLocal, int Prefix, bool connLocal = true)
    //    {
    //        List<retiroData> retiros = new List<retiroData>();
    //        retiroData r;
    //        List<SqlParameter> ParametersList = new List<SqlParameter>();
    ...
    //        SqlDataReader dataReader = Conexion.ExcuteReader("dbo.retiros_getOlder", ParametersList,connLocal);
    //        while (dataReader.Read())
    //        {
    ...
    //        return Conexion.ExecuteNonQuery("dbo.retiros_delete", ParametersList,true,connLocal);
    //    }

    //    public static List<retiroData> getmodiffied(Guid idlocal, int Prefix, bool connLocal = true)
    //    {
    ...
    //        ParametersList.Add(new SqlParameter("@id", idlocal));
    //        ParametersList.Add(new SqlParameter("@Prefix", Prefix));
    //        SqlDataReader dataReader = Conexion.ExcuteReader("dbo.retiros_getMod", ParametersList,connLocal);
    //        while (dataReader.Read())
    //        {
    //            r = CargoData(dataReader);
    //            retiros.Add(r);
    ...
    //    public static bool yaviqueestabasmodificadamacho(Guid id, int Prefix, bool connLocal = true)
    //    {
    //        List<SqlParameter> ParametersList = new List<SqlParameter>();
            
    //        ParametersList.Add(new SqlParameter("@id", id));
    //        ParametersList.Add(new SqlParameter("@Prefix", Prefix));
    //        return Conexion.ExecuteNonQuery("dbo.retiros_yavi", ParametersList,true,connLocal);
    //    }
