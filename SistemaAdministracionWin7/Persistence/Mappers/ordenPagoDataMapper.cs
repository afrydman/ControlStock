...
{
    public static class ordenPagoDataMapper
    {
        ...
        //    return Conexion.ExecuteNonQuery("dbo.[opago_Insert]", ParametersList);
        //}
        ...
        //    return Conexion.ExecuteNonQuery("dbo.[opagoDetalle_Insert]", ParametersList);
        //}
        ...
        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPago_SelectRow", ParametersList);
        ...
        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPago_SelectAll", null);
        //    while (dataReader.Read())
        //    {
        ...
        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPagoDetalle_SelectRow", ParametersList);
        //    while (dataReader.Read())
        //    {
        ...
        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPago_SelectLast", ParametersList);
        //    if (dataReader!=null)
        //    {
        ...
        //    return Conexion.ExecuteNonQuery("dbo.[opago_anular]", ParametersList);
        //}

        //public static reciboData getOrdenByCheque(Guid idcheque)
        //{
        //    reciboData r = new reciboData();
        //    List<SqlParameter> ParametersList = new List<SqlParameter>();
        //    ParametersList.Add(new SqlParameter("@idcheque", idcheque));
         

        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPago_SelectbyCheque", ParametersList);
        //    while (dataReader.Read())
        //    {
        ...
        //    SqlDataReader dataReader = Conexion.ExcuteReader("dbo.oPago_getbyfecha", ParametersList);
        //    while (dataReader.Read())
        //    {
