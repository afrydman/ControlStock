...
namespace SharedForms.LogService
{
    public static class LoggerConfig
    {
        ...
        public static void InitializeLogger(string loggerId, string fileName, LogLevel? minimumLevel = null)
        {
            ...
            Log.New(loggerId, fullPath, null, minimumLevel);
        }
        ...
        /// <summary>
        /// Initializes common loggers for the application
        /// </summary>
        public static void InitializeCommonLoggers()
        {
            // Application log
            InitializeLogger("app", "application.log", LogLevel.Info);
            
            // Error log (only errors and fatal)
            InitializeLogger("error", "errors.log", LogLevel.Error);
            
            // Debug log (everything)
            InitializeLogger("debug", "debug.log", LogLevel.Debug);
        }
