...
namespace Testing.Generics
{
    ...
    public class GenericGetBiggerTest
    {
        ...
        public void NotaCreditoCliente_GetBIgger()
        {
            ...
            testList.Add(HelperTesting.ServicesEnum.Codigo);
            fixture = HelperTesting.SetUp(testList);
            GetBiggerDocumentoGeneralData(new NotaService(new NotaCreditoClienteRepository(), new NotaCreditoClienteDetalleRepository(), new TributoNotaCreditoClientesRepository()), difExpected: 0);// se espera que falle pagos..
        }
        ...
        public void NotaCreditoProveedor_GetBIgger()
        {
            ...
            GetBiggerDocumentoGeneralData(new NotaService(new NotaCreditoProveedoresRepository(), new NotaCreditoProveedoresDetalleRepository(), new TributoNotaCreditoProveedoresRepository()), difExpected: 0);// se espera que falle pagos..
        }
        ...
        public void NotaDebitoCliente_GetBIgger()
        {
            ...
            testList.Add(HelperTesting.ServicesEnum.Codigo);
            fixture = HelperTesting.SetUp(testList);
            GetBiggerDocumentoGeneralData(new NotaService(new NotaDebitoClienteRepository(), new NotaDebitoClienteDetalleRepository(), new TributoNotaDebitoClientesRepository()), difExpected: 0);// se espera que falle pagos..
        }
        ...
        public void NotaDebitoProveedor_GetBIgger()
        {
            ...
            testList.Add(HelperTesting.ServicesEnum.Codigo);
            fixture = HelperTesting.SetUp(testList,false);
            GetBiggerDocumentoGeneralData(new NotaService(new NotaDebitoProveedoresRepository(), new NotaDebitoProveedoresDetalleRepository(), new TributoNotaDebitoProveedoresRepository()), difExpected: 0);// se espera que falle pagos..
        }
        ...
        [TestMethod]
        public void PuntoControl_GetBIgger()
        {
            List<HelperTesting.ServicesEnum> testList = new List<HelperTesting.ServicesEnum>();
            testList.Add(HelperTesting.ServicesEnum.Codigo);
            fixture = HelperTesting.SetUp(testList, false);
            GetBigger(service: new PuntoControlService(), difExpected: 0);// se espera que falle pagos..
        }
